...
- `/prompts:kiro-spec-change {feature} "change description"` - Create change request
  - `/prompts:kiro-validate-change {feature}` (optional: validate change request)
- `/prompts:kiro-spec-change-design {feature} [-y]` - Generate change design with integrated specs
  - `/prompts:kiro-validate-change-design {feature}` (optional: validate change design)
...
- `/prompts:kiro-spec-change-impl {feature} [tasks]` - Implement changes with TDD + regression focus
  - `/prompts:kiro-validate-change-impl {feature}` (optional: validate change implementation)
...
- `/prompts:kiro-validate-requirements {feature}` (optional: after requirements, before design)
