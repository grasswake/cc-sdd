...
### Error Scenarios
- **Missing Change Design**: If change-design.md doesn't exist, stop: "Run `/prompts:kiro-spec-change-design $1` first"
...
### Next Phase
**If GO**: Proceed to `/prompts:kiro-spec-change-tasks $1`
**If NO-GO**: Address issues and re-run `/prompts:kiro-spec-change-design $1`
