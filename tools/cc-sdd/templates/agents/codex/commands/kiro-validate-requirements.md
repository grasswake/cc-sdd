...
6. **Persistence**: Validation/review result is written and kept as a Markdown file
...
- **Missing Requirements**: If requirements.md doesn't exist, stop: "Run `/prompts:kiro-spec-requirements $1` first"
...
- **Optional**: Run `/prompts:kiro-validate-gap $1` for implementation gap analysis (brownfield projects)
- Then: Run `/prompts:kiro-spec-design $1 -y` to proceed to design phase
