...
**If GO**:
- Run `/prompts:kiro-spec-archive-change $1` to archive change and update original specs

**If NO-GO**:
- Address critical issues (especially regressions)
- Re-run `/prompts:kiro-spec-change-impl $1 [tasks]` for fixes
- Re-validate with `/prompts:kiro-validate-change-impl $1`
