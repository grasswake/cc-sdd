...
Delegate change design validation to validate-change-design-agent:

Use the Task tool to invoke the Subagent with file path patterns:

```
Task(
  subagent_type="validate-change-design-agent",
  description="Change design validation review",
  prompt="""
Feature: $1
