...
- If not all tasks complete: "Complete all change tasks first with `/kiro/spec-change-impl $1`"
...
- **Suggested Action**: "Run `/kiro/spec-change-impl $1` to complete remaining tasks"
...
- **Message**: "change-design.md is missing integrated requirements or design sections. Re-run `/kiro/spec-change-design $1`"
